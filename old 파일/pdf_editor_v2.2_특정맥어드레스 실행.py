...
class PDFEditorApp:
    def __init__(self, root):
        ...
        # 제목에 사용자 정보 포함
        if user_name:
            self.root.title(f"Kunhwa PDF Editor - {user_name}")
        else:
            self.root.title("Kunhwa PDF Editor")
        
        # 인증 정보 터미널 출력 (개인정보 제거)
        print(f"=== Kunhwa PDF Editor v2.2 ===")
    ...
    def setup_ui(self):
        ...
        copyright_text = f"© 2025 Kunhwa Engineering & Consulting | Developed by TaeWoong Jang | 인증된 사용자: {user_name}"
